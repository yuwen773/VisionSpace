...
let variantInstance: InstanceType<(typeof variantMap)[number]> | null = null
...
onMounted(async () => {
  ...
  variantInstance = new Cls(containerRef.value)
})
...
defineOptions({ name: 'ImageTrail' })
</script>

<template>
  <div
    ref="containerRef"
    class="z-[100] relative bg-transparent rounded-lg w-full h-full overflow-visible"
  >
    <div
